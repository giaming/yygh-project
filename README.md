...
本项目是一个预约挂号系统，包含了后台管理系统和前台用户系统，后台包括医院设置管理、数据管理、用户管理、订单管理和统计管理等功能，前台包含用户登录、就诊人管理、用户实名认证和预约挂号等功能。项目采用前后端分离的方式进行开发，前端基于Vue构建，后端采用SpringCloud微服务技术栈搭建。![image](https://user-images.githubusercontent.com/24700003/156306687-2d38ea0c-1a62-42fe-a4aa-887d74974131.png)
